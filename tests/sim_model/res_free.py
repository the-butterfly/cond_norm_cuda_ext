...
without BN or other normalization!
...
some modifications: (inspired by i-resnet: arxiv:1811.00995)
- elu
- actnorm: openai/glow, a simple linear affine function.
- LConv / LLinear
- pre-activation ResNet
- dimension squeezing / affine coupling layers: Glow / Read NVP: checkboard pattern
'''
